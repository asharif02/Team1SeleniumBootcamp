...
public class EndToEnd extends SystemBar {
    ...
    public void testAddToCart() throws InterruptedException {
        ...
        String expectedText = excel.readStringList("addToCart").get(0);
        String actualText = String.valueOf(driver.findElement(By.xpath("//*[@id='layer_cart']//div[1]//div[1]//h2//i"))).trim();
